...
/**
 * Está classe trata das informações de cada usuário alimentado pelo mapa em seu construtor.
 *
...
public class Usuarios {
    ...
    /**
         ...
         * @param opinioes Mapa contendo como chave os perfis e Values Array de String com os votos de cada perfil.
         */    
	...
	public String[] getOpinioes(String usuario) {
        ...
        /**
         * Metodo cria uma Arry de string contendo em ordem decrescente os nomes dos perfis mais semelhantes ao do usuario informado
         * @param usuario Nome do usuário para comparação
         * @return Array de String 
         * @throws Exception Não é permitido usuarios null ou em branco.
         */
        ...
        /**
         * Metodo cria uma Array de string contendo em ordem decrescente os nomes dos perfis mais semelhantes as notas informadas
         * @param minhasNotas Array de notas para comparação
         * @return Array de String 
         * @throws Exception Não é permitido lista vazia ou null.
         */

        public String[] usuariosSemelhantes(Integer[] minhasNotas)
			throws Exception {
                if (minhasNotas == null){
